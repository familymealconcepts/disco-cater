        ...
        {tab === 'login' && (
          <form onSubmit={handleLogin}>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              <button type="button" className="auth-oauth-btn" onClick={() => { window.location.href = 'https://api.familymeal.com/oauth2/authorization/google' }}>
              ...
              <button type="button" className="auth-oauth-btn" onClick={() => { window.location.href = 'https://api.familymeal.com/oauth2/authorization/facebook' }}>
