...
const NAV = [
  ...
  { href: '/account/profile', label: 'Profile', icon: <SvgProfile /> },
...
function SidebarContent({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: '16px 10px' }}>
      ...
      {/* Section label */}
      {!collapsed && (
        <div style={{ fontSize: 10, fontWeight: 700, color: '#bbb', textTransform: 'uppercase', letterSpacing: '0.08em', padding: '0 8px', marginBottom: 6 }}>
          Account
        </div>
      )}
