    ...
    <div style={{ minHeight: '100svh', background: '#F9FAFB', fontFamily: F, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '48px 20px 64px' }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .fr-card:hover { transform: translateY(-2px); border-color: #5B6FE8; box-shadow: 0 8px 28px rgba(26,16,40,0.10); }
      ...
      <div style={{ width: '100%', maxWidth: 620, textAlign: 'center' }}>
        ...
        {/* Action cards — large tap targets, stacked */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          {CARDS.map(c => (
            <Link key={c.href} href={c.href} className="fr-card" style={{
              ...
              boxShadow: '0 2px 10px rgba(26,16,40,0.05)',
            }}>
              <div style={{ minWidth: 0 }}>
