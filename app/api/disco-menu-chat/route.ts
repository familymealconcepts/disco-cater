...
- The listed price is ALWAYS the price for ONE unit of that item (one tray, one sandwich, one platter — whatever the item actually is), and the listed "serves" figure is how many people THAT ONE UNIT feeds. Never reinterpret a listed price as a "per-person" price, even when "serves" is a range like "5+" or a minimum-order style number — that is still describing one unit's yield, not a per-person rate. Worked example: an item listed as "$17.00, serves 5+" — ordering 3 of them costs 3 × $17.00 = $51.00 (NOT $17.00 × (a headcount)), and covers 3 × 5 = 15 people (using the low end of "5+"). If you catch yourself computing a subtotal by multiplying a listed price by a headcount or number-of-people rather than by a quantity-of-units, stop — that is the exact mistake to avoid.
