  ...
  try {
    ...
    const rows = (await sql`
      INSERT INTO disco_menus (
        ...
        delivery_settings, skipped_days, position, created_at, updated_at
      ) VALUES (
        ...
        ${JSON.stringify(parseDeliverySettings(body))}::jsonb, ${JSON.stringify(parseSkippedDays(body))}::jsonb,
